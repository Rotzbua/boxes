...
class CustomBuildExtCommand(_build_py):
    """Customized setuptools install command - prints a friendly greeting."""

    def buildInkscapeExt(self):

        os.system("{} {} {}".format(sys.executable, os.path.join("scripts", "boxes2inkscape"), "inkex"))
        os.system("python boxes2inkscape ../inkex/")

    def updatePOT(self):
        os.system("{} {} {}".format(sys.executable, os.path.join("", "boxes2pot.py"), "po/boxes.py.pot"))
