...
class OttoLegs(Boxes):
    ...
    def __init__(self) -> None:
        ...
        self.addSettingsArgs(
            edges.FingerJointSettings, finger=1.0, space=1.0, surroundingspaces=1.0
        )
    ...
    def foot(self, x, y, ly, l, r=5.0, move=None):
    ...
    def render(self):
        ...
        for i in range(2):
            ...
            self.rectangularWall(
                lx,
                lh - 7.0,
                [LegEdge(self, None), "f", "F", "f"],
                callback=[None, lambda: self.fingerHolesAt(ws - 7.0, 0, lx)],
                move="right",
            )
            # back
            self.rectangularWall(
                ...
                lh,
                "FfFf",
                callback=[lambda: self.hole(lx / 2, 7, self.anklebolt2 / 2)],
                move="right",
            )
            # sides
            self.rectangularWall(
                ...
                lh,
                e,
                callback=[None, lambda: self.fingerHolesAt(ws, 7.0, ly - 7.0 - 3.0)],
                move="right",
            )
            self.rectangularWall(
                ly,
                ...
                callback=[
                    ...
                    lambda: self.fingerHolesAt(ws, 7.0, ly - 7.0 - 3.0),
                ],
                move="right",
            )
        ...
        self.partsMatrix(
            ...
            ly,
            "eeee",
            callback=[lambda: self.hole(lx / 2, ly / 2, 1.5)],
        )
        ...
        # hold servo inside
        self.partsMatrix(
            2, 1, "right", self.rectangularWall, lx, ly - 7.0 - 3.0, "efef"
        )
