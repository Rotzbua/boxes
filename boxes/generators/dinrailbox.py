...
class DinRailEdge(edges.FingerHoleEdge):
    ...
    def __call__(self, length, bedBolts=None, bedBoltSettings=None, **kw):
        with self.saved_context():
            self.fingerHoles(
                0,
                self.burn + 8 + self.settings.thickness / 2,
                length,
                0,
                bedBolts=bedBolts,
...
class DinRailBox(Boxes):
    ...
    def __init__(self) -> None:
        ...
        self.addSettingsArgs(edges.FingerJointSettings, surroundingspaces=0.8)
    ...
    def render(self):
        ...
        self.rectangularWall(
            ...
            "EEEE",
            callback=[
                lambda: self.fingerHolesAt(0.55 * t, 0.05 * t, y - 0.1 * t, 90),
                None,
                lambda: self.fingerHolesAt(0.55 * t, 0.05 * t, y - 0.1 * t, 90),
                None,
            ],
        ...
        self.lid_lip(y - 0.1 * t, move="rotated right")
        self.lid_lip(y - 0.1 * t, move="rotated right")
        ...
        self.rectangularWall(
            ...
            ["h", "f", "e", "f"],
            ignore_widths=[1, 6],
            callback=[self.spring, None, self.lid_holes],
            move="up",
            label="Bottom",
        )
        self.rectangularWall(
        ...
        self.rectangularWall(
            ...
            8,
            "feee",
            callback=[lambda: self.rectangularHole(x / 2, 2.05 - 0.5 * t, t, t + 4.1)],
            move="up",
        )
