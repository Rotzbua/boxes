...
class Gears(Boxes):
    ...
    def __init__(self) -> None:
        ...
        self.argparser.add_argument(
            "--teeth1", action="store", type=int, default=12, help="number of teeth"
        )
        self.argparser.add_argument(
            "--shaft1",
            action="store",
    ...
    def render(self):
        ...
        self.gears(
            ...
            angle=self.pressure_angle,
            profile_shift=self.profile_shift,
            callback=lambda: self.dHole(
                0, 0, d=self.shaft2, rel_w=self.dpercentage2 / 100.0
            ),
            move="up",
        )
        ...
        self.gears(
            ...
            profile_shift=self.profile_shift,
            callback=lambda: self.dHole(
                0, 0, d=self.shaft1, rel_w=self.dpercentage1 / 100.0
            ),
            move="up",
        )
