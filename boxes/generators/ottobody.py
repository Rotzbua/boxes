...
class OttoBody(Boxes):
    ...
    def bottomCB(self):
        ...
        self.hexHolesCircle(
            12, HexHolesSettings(self, diameter=2, distance=2, style="circle")
        )
    ...
    def render(self):
        ...
        self.rectangularWall(
            x, h - hx, "FfOf", ignore_widths=[2], move="up", label=_("Left bottom side")
        )
        self.rectangularWall(
            x, hl - hx2, "pfFf", ignore_widths=[1], move="up", label=_("Left top side")
        )
        self.moveTo(-hx)
        self.rectangularWall(
            x,
            ...
            "Ffof",
            ignore_widths=[5],
            callback=[lambda: self.rectangularHole(y - 7.5, h - 4 - 7.5, 6.2, 7.0)],
            move="up",
            label=_("Right bottom side"),
        )
        self.rectangularWall(
            x,
            hl - hx2,
        ...
        self.rectangularWall(
            ...
            h,
            "FFeF",
            callback=[None, None, self.frontCB],
            move="up",
            label=_("Lower front"),
        )
        self.rectangularWall(y, h, e_back, move="up", label=_("Lower back"))

        # upper walls
        self.rectangularWall(
            y, hl, "FFeF", callback=[self.eyeCB], move="up", label=_("Upper front")
        )
        ...
        # bottom
        self.rectangularWall(
            x, y, "ffff", callback=[self.bottomCB], move="up", label=_("Bottom")
        )
        # PCB mounts
        ...
        self.rectangularWall(
            y,
            14,
            callback=[None, None, None, self.leftBottomCB],
            move="up",
            label=_("Servo mount"),
        )
        self.rectangularWall(
            y - 5.6,
            14,
            callback=[None, None, None, self.rightBottomCB],
            move="up",
            label=_("Servo mount"),
        )
