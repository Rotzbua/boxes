...
"""
    ...
    def borders(self):
        ...
        panel = min(
            (h - fh) / math.cos(math.radians(90 - self.angle)),
    ...
    def render(self):
        ...
        if self.glued_panel:
            ...
            self.rectangularWall(
                borders[4], x - 2 * t, "hEhE", move="right", label="Panel"
            )
        else:
            ...
            self.rectangularWall(
                ...
                callback=[
                    ...
                    lambda: self.fingerHolesAt(
                        0.5 * t, 0, borders[-2] - 4.05 * t - latchpos
                    ),
                    lambda: self.latch_hole(borders[-2] - 1.2 * t - latchpos),
                    lambda: self.fingerHolesAt(
                        0.5 * t, 3.05 * t + latchpos, borders[-2] - 4.05 * t - latchpos
                    ),
                ],
                move="right",
                label="Back Wall",
