...
"""
    ...
    def five(self, x, y, s):
        ...
        for dx in (-1, 1):
            for dy in (-1, 1):
                self.hole(x + dx * 0.25 * s, y + dy * 0.25 * s, 0.05 * s)
                self.hole(x + dx * 0.25 * s, y + dy * 0.25 * s, 0.12 * s)
    ...
    def player2(self, x=0, y=0):
        ...
        for dx in (-1, 1):
            for dy in (-1, 1):
                self.hole(x + dx * 0.2 * s, y + dy * 0.2 * s, 0.07 * s)
    ...
    def render(self):
        ...
        self.rectangularWall(
            ...
            h,
            "nlmE",
            callback=[lambda: self.hole(y / 2, h / 2, d=0.6 * h)],
            move="up",
        )
