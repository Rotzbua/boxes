...
class EuroRackSkiff(Boxes):
    ...
    def __init__(self) -> None:
        ...
        self.argparser.add_argument(
            "--hp", action="store", type=int, default=84, help="Width of the case in HP"
        )
    ...
    def render(self):
        ...
        self.rectangularWall(y, 6, "feee", callback=[self.railHoles], move="up")
        self.rectangularWall(x, h, "fFeF", callback=[self.wallxCB(x)], move="right")
        self.rectangularWall(y, h, "ffef", callback=[self.wallyCB(y)], move="up")
        self.rectangularWall(y, h, "ffef", callback=[self.wallyCB(y)])
        self.rectangularWall(x, h, "fFeF", callback=[self.wallxCB(x)], move="left up")
